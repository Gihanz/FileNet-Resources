...
function(declare, lang,ContentViewer) {		
	 ...
	 */
lang.setObject("customViewerOpen", function(repository, items, callback, teamspace, resultSet, parameterMap) {
 /*
...
lang.setObject("customViewerPreview", function(repository, items, callback, teamspace, resultSet, parameterMap) {
 /*
  * Add custom code for your action here. For example, your action might launch a dialog or call a plug-in service.
  */
	// action definition only permits one object in the array
