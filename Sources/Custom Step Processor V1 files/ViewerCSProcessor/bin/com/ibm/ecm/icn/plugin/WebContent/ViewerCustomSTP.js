...
function(declare, lang) {		
	 ...
	 */
lang.setObject("openAction", function(repository, items, callback, teamspace, resultSet, parameterMap,ContentViewer) {
 /*
...
lang.setObject("viewAction", function(repository, items, callback, teamspace, resultSet, parameterMap,ContentViewer) {
 /*
  * Add custom code for your action here. For example, your action might launch a dialog or call a plug-in service.
  */
	...
	if (window.contentViewer != null) {
	// open the document in the viewer
	window.contentViewer.preview(item,false);
	} 
	}
	console.log("Preview");
});
