...
1) CustomSearchPlugin Chapter5.zip
   Eclipse Project for the CustomSearchPlugin project in Chapter 5 of the book
...
you can import the project in your workspace.
...
You may need to run build.xml as ant script to build the jar file named CustomSearchPlugin.jar 
as the IBM Content Navigator plug-in to be deployed.