...
public class OpenContentClassFilter extends PluginResponseFilter {
	...
	public String[] getFilteredServices() {
		return new String[] { "/cm/openContentClass","/p8/openContentClass" };
	}
	...
	public void filter(String serverType, PluginServiceCallbacks callbacks,
		...
		// fill in the initial property values to pass to EDS.  These would be the default values
		JSONArray jsonProperties = (JSONArray)jsonResponse.get("criterias");
		String symbolicName = jsonResponse.get("template_name").toString();
	...
	public void updateJSONPropertiesOrder(JSONArray jsonProperties){
		...
		for (int i = 0; i < PropertiesOrder.length; i++) {
			for (int j = 0; j < jsonProperties.size(); j++) {
				...
				if (jsonProperty.get("name").toString().equals(PropertiesOrder[i])) {
