...
public class SamplePluginAsyncTaskType extends PluginAsyncTaskType {
	...
	public String getClassHandlerName(){
		return "com.ibm.ecm.extension.sample.asyncTasks.SampleICNTask";
	}
	...
	public String getTaskCreationDialogDijitClass() {
		return "samplePluginDojo/asyncTasks/ICNSampleTaskCreationDialog";
	}
