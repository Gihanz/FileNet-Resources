...
define([
	...
	"dojo/text!./templates/StepProcessorEDULayout.html"
], function(declare, lang, connect, LoggerMixin, _ProcessorMixin, StepProcessorLayout, template) {
	/**
	 * @name ecm.custom.widget.process.StepProcessorEDULayout
	 * @class Provides a custom layout for step processors.
	 * @augments ecm.custom.widget.process.StepProcessorLayout
	 */
	return declare("ecm.custom.widget.process.StepProcessorEDULayout", [
		StepProcessorLayout
	], {
		/** @lends ecm.custom.widget.process.StepProcessorEDULayout.prototype */
