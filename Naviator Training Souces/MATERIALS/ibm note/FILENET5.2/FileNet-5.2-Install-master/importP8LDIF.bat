...
echo Importing sample users and groups to IBM Tivoli Directory Server ...
echo --------------------

copy "%ScriptsDir%\P8Sample.ldif" "%PBSTargetDrive%%PBSTargetRootDir%\%TDS63TargetDirName%\sbin"

pushd "%PBSTargetDrive%%PBSTargetRootDir%\%TDS63TargetDirName%\sbin"
set INSTALLER-NAME=idsldif2db.cmd

if not exist %INSTALLER-NAME% goto EXIT_ERROR
call %INSTALLER-NAME% -i P8Sample.ldif -I dsrdbm01
popd

time /t
:EXIT_OK
echo End importP8LDIF.bat
echo ====================
exit 0
