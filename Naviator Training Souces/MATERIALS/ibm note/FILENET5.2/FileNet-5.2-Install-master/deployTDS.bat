...
call "C:\Program Files\IBM\WebSphere\AppServer\profiles\AppSrv01\bin\wsadmin.bat" -conntype SOAP -port 8880 -user P8Admin -password IBMFileNetP8 -profileName AppSrv01 -lang jacl -f deployTDS.tcl

popd
 
time /t
echo End deployTDS.bat
echo ====================
